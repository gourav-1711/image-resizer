...
export default function Home() {
  ...
  const [settings, setSettings] = useState({
    quality: 75,
    format: "webp" as "webp" | "jpeg" | "png" | "ico",
    maxWidth: 1920,
    maxHeight: 1080,
    removeMetadata: true,
  ...
  const handleOptimize = useCallback(async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const errorMessage =
          errorData.details || errorData.error || "Optimization failed";
        ...
        <div className="flex justify-between items-start mb-12">
          <div className="flex-1">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">
              Compress, resize, and convert your images instantly. No
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 pt-12 border-t border-border">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Process images instantly in the browser
            </p>
          </div>
          <div className="text-center">
            <div className="bg-primary/10 w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              Get optimized images instantly, no uploads
            </p>
          </div>
          <div className="text-center">
            <div className="bg-primary/10 w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              Your images are never stored anywhere
            </p>
          </div>
        </div>
